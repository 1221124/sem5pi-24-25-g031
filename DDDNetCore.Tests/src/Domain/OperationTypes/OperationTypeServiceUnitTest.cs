...
namespace DDDNetCore.Tests.Domain.OperationTypes
{
    public class OperationTypeServiceUnitTest : IClassFixture<TestDatabaseFixture>
    {
        ...
        public OperationTypeServiceUnitTest(TestDatabaseFixture fixture)
        {
        ...
        public async Task Create_ShouldCreateOperationType_WhenAdminRegistersValidOperationTypeAsync()
        {
            ...
            Assert.Equal(3, OperationType.PhasesDuration.Phases.Count);
            ...
            Assert.Equal(addedOperationType.PhasesDuration.Phases.Count, OperationType.PhasesDuration.Phases.Count);
        }
        ...
        public async Task GetByIdAsync_ReturnsOperationType_WhenIdExists()
        {
            ...
            Assert.Equal(OperationType.PhasesDuration.Phases.Count, result.PhasesDuration.Phases.Count);
        }

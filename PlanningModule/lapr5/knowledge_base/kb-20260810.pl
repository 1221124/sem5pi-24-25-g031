...
surgery_id(req6,aCL_Reconstrution_Surgery).

agenda_operation_room(or1,20260810,[(135,269,ap4),(270,404,ap2),(405,539,ap3),(0,134,ap5),(540,674,ap1)]).
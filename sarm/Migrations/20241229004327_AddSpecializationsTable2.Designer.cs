...
namespace DDDNetCore.Migrations
{
    ...
    [Migration("20241229004327_AddSpecializationsTable2")]
    partial class AddSpecializationsTable2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DDDNetCore.src.Domain.RoomTypes.RoomType", b =>
                {
                    ...
                    b.Property<string>("AvailableForSurgeries")
                        .IsRequired()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Domain.OperationTypes.OperationType", b =>
                {
                    b.OwnsOne("Domain.OperationTypes.PhasesDuration", "PhasesDuration", b1 =>
                        {
                            b1.Property<string>("OperationTypeId")
                                .HasColumnType("text");

                            b1.Property<int>("Cleaning")
                                .HasColumnType("integer")
                    ...
                    b.OwnsMany("Domain.OperationTypes.RequiredStaff", "RequiredStaff", b1 =>
                        {
                            b1.Property<string>("OperationTypeId")
                                .HasColumnType("text");
                            ...
                            b1.Property<string>("IsRequiredInCleaning")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("IsRequiredInCleaning");

                            b1.Property<string>("IsRequiredInPreparation")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("IsRequiredInPreparation");

                            b1.Property<string>("IsRequiredInSurgery")
                                .IsRequired()
                                .HasColumnType("text")

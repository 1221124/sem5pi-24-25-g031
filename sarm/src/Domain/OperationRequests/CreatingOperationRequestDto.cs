...
namespace DDDNetCore.Domain.OperationRequests
{
    public class CreatingOperationRequestDto
    {
        ...
        public CreatingOperationRequestDto(LicenseNumber staff, MedicalRecordNumber patient, OperationTypeCode operationType, DeadlineDate deadlineDate, Priority priority)
        {
            Staff = staff;
            Patient = patient;

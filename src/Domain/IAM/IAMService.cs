...
namespace DDDSample1.Domain.Categories
{
    public class IAMService
    {
        ...
        public FirestoreService()
        {
            ...
            string pathToServiceAccountKey = "caminho/para/seu/arquivo-chave.json";
            Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", pathToServiceAccountKey);
            
            // Inicializa o Firestore
            _firestoreDb = FirestoreDb.Create("seu-projeto-id"); // Substitua pelo seu ID do projeto
        }

        // Métodos para interagir com o Firestore
